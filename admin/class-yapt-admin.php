...
class Yapt_Admin
{
    ...
    public function setupSettingsMenu(): void
    {
        ...
        $hook = add_menu_page(
            'ViserX pricing tables',                      // Page title: The title to be displayed in the browser window for this page.
            'ViserX Pricing Table',                              // Menu title: The text to be used for the menu.
        ...
        add_submenu_page('yapt_admin', 'Add new pricing table', __('Add New', 'ya-pricing-table'), 'manage_options', 'yapt_admin_add_page', [$this, 'renderAddPageContent']);
